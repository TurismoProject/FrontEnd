        ...
        <div className="w-full p-8 space-y-8">
          ...
          <div className="space-y-4">
            <div className="relative w-sm">
              ...
              >
                <Link href="/login/provedor" className="w-full">
                  <span className="text-black">Sou um Provedor</span>
                </Link>
              </Button>
            </div>
            <div className="relative w-sm">
              ...
              >
                <Link href="/login/usuario" className="w-full">
                  <span>Sou um Usuário</span>
                </Link>
              </Button>
            </div>
          </div>
