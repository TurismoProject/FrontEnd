...
const product = {
  ...
  href: "#",
  breadcrumbs: [
    { id: 1, name: "Categorias", href: "#" },
    { id: 2, name: "Passeios", href: "#" },
  ],
  images: [
    {
  ...
  destaques: [
    ...
    "Visita a pontos exclusivos para contemplação das falésias",
      ...
      <div className="pt-6">
        ...
        <div className="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8">
          <div className="aspect-h-4 aspect-w-3 hidden overflow-hidden rounded-lg lg:block">
            <Image
              src="/mar.jpg"
              width={200} // Aumente a largura e a altura conforme necessário
              height={200}
              className="h-full w-full object-cover object-center"
              alt="Logo"
              quality={100} // Define a qualidade da imagem para 100%
              priority // Carrega a imagem prioritariamente, útil para imagens acima da dobra
            />
          </div>
            ...
            <form className="mt-10">
              ...
              <div className="mt-10">
                ...
                <fieldset aria-label="Choose a size" className="mt-4">
                  ...
                  >
                    {product.pessoas.map((pessoa) => (
                      <Radio
                        key={pessoa.name}
                        value={pessoa}
                        disabled={!pessoa.inStock}
                        className={classNames(
                          pessoa.inStock
